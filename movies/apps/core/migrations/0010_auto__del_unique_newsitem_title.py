...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'NewsItem', fields ['title']
        db.delete_unique('core_newsitem', ['title'])


    def backwards(self, orm):
        # Adding unique constraint on 'NewsItem', fields ['title']
        db.create_unique('core_newsitem', ['title'])
