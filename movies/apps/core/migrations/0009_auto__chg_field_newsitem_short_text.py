...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('core_newsitem', 'short_text', self.gf('django.db.models.fields.TextField')())

    def backwards(self, orm):

        # Changing field 'NewsItem.short_text'
        db.alter_column('core_newsitem', 'short_text', self.gf('django.db.models.fields.CharField')(max_length=100))
