...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'StudioMotivationInfo.studio'
        db.alter_column('core_studiomotivationinfo', 'studio_id', self.gf('annoying.fields.AutoOneToOneField')(to=orm['core.MovieStudio'], unique=True))
        # Adding unique constraint on 'StudioMotivationInfo', fields ['studio']
        db.create_unique('core_studiomotivationinfo', ['studio_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'StudioMotivationInfo', fields ['studio']
        db.delete_unique('core_studiomotivationinfo', ['studio_id'])


        # Changing field 'StudioMotivationInfo.studio'
        db.alter_column('core_studiomotivationinfo', 'studio_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.MovieStudio']))
