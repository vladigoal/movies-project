...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'NewsItem.movie'
        db.add_column('core_newsitem', 'movie',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Movie'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'NewsItem.movie'
        db.delete_column('core_newsitem', 'movie_id')
