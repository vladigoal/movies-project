...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'StudioMotivationProgress', fields ['info', 'user']
        db.create_unique('core_studiomotivationprogress', ['info_id', 'user_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'StudioMotivationProgress', fields ['info', 'user']
        db.delete_unique('core_studiomotivationprogress', ['info_id', 'user_id'])
    ...
    models = {
        ...
        'core.studiomotivationprogress': {
            'Meta': {'unique_together': "(('info', 'user'),)", 'object_name': 'StudioMotivationProgress'},
