...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'StudioMotivationInfo'
        db.create_table('core_studiomotivationinfo', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('studio', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.MovieStudio'])),
            ('reputation_bonus', self.gf('django.db.models.fields.SmallIntegerField')(default=1, blank=True)),
            ('watch_minutes_bonus', self.gf('django.db.models.fields.SmallIntegerField')(default=1, blank=True)),
        ))
        db.send_create_signal('core', ['StudioMotivationInfo'])

        # Adding model 'StudioMotivationProgress'
        db.create_table('core_studiomotivationprogress', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('info', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.StudioMotivationInfo'])),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='motivationprogress_actor', to=orm['auth.User'])),
        ))
        db.send_create_signal('core', ['StudioMotivationProgress'])

        # Adding M2M table for field friends on 'StudioMotivationProgress'
        db.create_table('core_studiomotivationprogress_friends', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('studiomotivationprogress', models.ForeignKey(orm['core.studiomotivationprogress'], null=False)),
            ('user', models.ForeignKey(orm['auth.user'], null=False))
        ))
        db.create_unique('core_studiomotivationprogress_friends', ['studiomotivationprogress_id', 'user_id'])

        # Adding model 'MovieStudio'
        db.create_table('core_moviestudio', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('title', self.gf('django.db.models.fields.CharField')(unique=True, max_length=100)),
            ('slug', self.gf('django.db.models.fields.SlugField')(unique=True, max_length=100, blank=True)),
            ('logo', self.gf('django.db.models.fields.files.ImageField')(max_length=100)),
            ('logo_width', self.gf('django.db.models.fields.SmallIntegerField')(default=0, blank=True)),
            ('logo_height', self.gf('django.db.models.fields.SmallIntegerField')(default=0, blank=True)),
        ))
        db.send_create_signal('core', ['MovieStudio'])

        # Adding field 'Movie.studio'
        db.add_column('core_movie', 'studio',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.MovieStudio'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'StudioMotivationInfo'
        db.delete_table('core_studiomotivationinfo')

        # Deleting model 'StudioMotivationProgress'
        db.delete_table('core_studiomotivationprogress')

        # Removing M2M table for field friends on 'StudioMotivationProgress'
        db.delete_table('core_studiomotivationprogress_friends')

        # Deleting model 'MovieStudio'
        db.delete_table('core_moviestudio')

        # Deleting field 'Movie.studio'
        db.delete_column('core_movie', 'studio_id')
    ...
    models = {
        ...
        'core.studiomotivationinfo': {
            ...
            'studio': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['core.MovieStudio']"}),
