...
admin.site.register(models.MovieStudio, admin.ModelAdmin)
admin.site.register(models.StudioMotivationInfo, admin.ModelAdmin)
admin.site.register(models.StudioMotivationProgress, admin.ModelAdmin)
